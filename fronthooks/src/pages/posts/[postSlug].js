          ...
          <div className="flex gap-x-4 items-center">
            ...
            <div className="gap-y-3 flex flex-col">
              <div className="flex items-center gap-x-2">
                ...
                <span className="text-sm font-light px-2 rounded-2xl bg-white border border-green-500">
          ...
          <div className="flex gap-x-4 items-center">
            ...
            <button className="flex items-center text-gray-500 hover:text-gray-600 border border-gray-400 px-3 py-1 rounded-2xl">
              <span className="text-sm font-light">
                {postData.isBookmarked ? "ذخیره شده" : "ذخیره"}
              </span>
              {postData.isBookmarked ? (
                <BookmarkIconSolid className="h-5 w-5 fill-current" />
              ) : (
                <BookmarkIcon className="h-5 w-5 stroke-current" />
              )}
            </button>
          </div>
        </header>
          ...
          <div className="grid grid-cols-6 gap-4">
            {postData.related.map((post) => {
              return (
                <div
                  key={post._id}
                  className="bg-white col-span-6 sm:col-span-3 md:col-span-2 rounded-xl overflow-hidden p-2 "
                >
